        ...
        <div className='digits-landing-background'>
          <Grid container stackable centered columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h1' inverted>Mutiple Users</Header>
            ...
            <Grid.Column textAlign='center' >
              ...
              <Header as='h1' inverted='white'>Contact Details</Header>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h1' inverted='white'>Timestamped Notes</Header>
              <Header as='h3' inverted>Each time you make contact with a contact, you cna write a note that summarizes the conservation. This note is saved along with a timestamp with the contact.</Header>
            </Grid.Column>
